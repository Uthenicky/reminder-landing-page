...
import { Bot, FileSpreadsheet, Send, Users } from "lucide-react";
...
const features = [
  {
    ...
    description: "Kelola data siswa beserta kontak dengan mudah.",
    icon: <Users className="w-5 h-5 text-primary" />
  },
  {
    title: "Import Data Siswa",
    description: "Upload data siswa secara masal.",
  ...
  {
    title: "Tangkap Calon Pelanggan Baru",
    description: "AI dapat menjawab pertanyaan calon pelanggan baru dan admin dapat memantau.",
      ...
      >
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground leading-relaxed">
            ...
            melakukan follow-up pembayaran sesuai jadwal yang Anda tentukan.
          </p>
        </div>
        ...
        <Card className="border-0 shadow-2xl shadow-primary/5 bg-white/80 backdrop-blur-xl overflow-hidden">
          <div className="bg-primary px-4 py-3 flex items-center gap-3">
            ...
            <div className="text-white">
              <div className="font-semibold text-sm">Orang Tua Siswa</div>
          ...
          <CardContent className="p-4 space-y-4 bg-[url('https://web.whatsapp.com/img/bg-chat-tile-dark_a4be512e7195b6b733d9110b408f075d.png')] bg-contain dark:bg-zinc-900 dark:bg-none">
            <div className="flex gap-2 mb-2">
              <div className="bg-white dark:bg-zinc-800 p-3 rounded-2xl rounded-tl-sm shadow-sm max-w-[85%] text-sm">
                <span className="font-semibold text-primary">Reminder Tagihan SPP</span>
                <br /><br />
                Halo Bapak/Ibu Wali dari <strong>Wiwin Sugiarti</strong>,
                <br /><br />
            ...
            <div className="flex gap-2 justify-end mt-4">
              <div className="bg-primary/10 dark:bg-primary/5 p-3 rounded-2xl rounded-tr-sm shadow-sm max-w-[85%] text-sm">
                ...
                <div className="text-[10px] text-right text-primary/70 mt-2">10:15 ✓✓</div>
              </div>
            </div>
            <div className="flex gap-2 mt-4">
              <div className="bg-white dark:bg-zinc-800 p-3 rounded-2xl rounded-tl-sm shadow-sm max-w-[85%] text-sm border-l-4 border-primary">
                <span className="font-semibold text-primary">✅ Pembayaran Berhasil</span>
                <br /><br />
                Terima kasih, pembayaran sebesar <strong>Rp 500.000</strong> untuk adinda Wiwin Sugiarti telah kami terima.
