...
import { GraduationCap, Plane, Store } from "lucide-react";
  ...
  return (
    <section id="business-modules" className="container py-24 sm:py-32">
      <div className="text-center space-y-4 mb-12">
        ...
        >
          Apapun bisnis Anda, Lancar Iuran hadir dengan modul khusus yang disesuaikan
      ...
      >
        <Tabs defaultValue="education" className="w-full flex flex-col items-center">
          <TabsList className="grid w-full max-w-2xl grid-cols-3 h-auto p-1 bg-muted/50 rounded-2xl mb-12 border border-border">
            <TabsTrigger 
              value="education" 
              className="rounded-xl py-3 data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-emerald-600 transition-all"
            >
            ...
            <TabsTrigger 
              value="travel" 
              className="rounded-xl py-3 data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-sky-600 transition-all"
            >
              <div className="flex flex-col items-center gap-2">
                <Plane className="w-5 h-5" />
                <span className="font-medium text-sm hidden sm:inline">Tour & Travel</span>
              </div>
            </TabsTrigger>
            <TabsTrigger 
              value="store" 
              className="rounded-xl py-3 data-[state=active]:bg-white data-[state=active]:shadow-md data-[state=active]:text-orange-600 transition-all"
            >
              <div className="flex flex-col items-center gap-2">
